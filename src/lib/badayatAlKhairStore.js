...
export const badayatTemplateGroups = [
  { group: 'العقود والتعيين', items: ['عقد عمل شامل', 'عرض عمل', 'ملحق عقد عمل', 'تعديل مسمى وظيفي', 'ترقية وظيفية', 'إقرار مباشرة عمل', 'إقرار استلام نسخة عقد', 'إقرار فترة تجربة'] },
  { group: 'الجزاءات والتحقيق', items: ['إنذار أول', 'إنذار نهائي', 'إخطار مخالفة', 'نموذج تحقيق إداري', 'نموذج خصم بسبب غياب', 'نموذج خصم بسبب جزاء', 'قرار إيقاف مؤقت عن العمل', 'نموذج فصل', 'محضر امتناع عن التوقيع'] },
  { group: 'العهد والاستلام', items: ['إقرار استلام مبلغ', 'إقرار استلام عهدة', 'استلام وتسليم عهدة', 'إقرار إرجاع عهدة', 'إقرار مسؤولية عهدة سيارة', 'إقرار استلام مفاتيح/بطاقة/جهاز', 'تسليم جواز السفر للشركة طواعية بدلاً من سداد ضمان العهدة'] },
  { group: 'الإجازات والمستحقات', items: ['طلب إجازة', 'نموذج موافقة إجازة', 'نموذج رفض إجازة', 'نموذج سلفة', 'إقرار استلام راتب', 'إقرار استلام مستحقات نهاية الخدمة', 'نموذج استقالة', 'إقرار مخالصة مؤقتة'] },
  { group: 'السياسات والإقرارات', items: ['نموذج تعهد بعدم التكرار', 'نموذج تنبيه وتوجيه', 'لائحة داخلية للعقوبات والخصومات', 'إقرار اطلاع الموظف على موانع ومحظورات وسياسة الشركة', 'إقرار سرية وعدم إفشاء', 'إقرار عدم منافسة وعدم استقطاب', 'تعهد المحافظة على العملاء والأسعار'] },
  { group: 'المراسلات الرسمية', items: ['خطاب موجه للموظف', 'طلب مستندات من الموظف', 'إشعار تحديث بيانات', 'إفادة لمن يهمه الأمر', 'شهادة خبرة', 'خطاب إنهاء خدمات وطلب تسليم عهد'] },
]
